...
#if DEBUG
    self.questionLabel.text = @"ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？";
    self.answerView.text = @"ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？ARC下对象的property属性修饰词有哪些？不显式指定任何修饰词时，默认的修饰词是什么？";
#endif
}
